              ...
              >
                <a
                  onClick={e => {
                    ...
                    // change the URL/hash without scrolling
                    try {
                      if (item.href && item.href.startsWith('#')) {
                        history.pushState(null, '', item.href);
                      }
                    } catch (err) {
                      // fallback: set location.hash but avoid scrolling by saving/restoring scroll
                      const scrollX = window.scrollX || window.pageXOffset;
                      const scrollY = window.scrollY || window.pageYOffset;
                      if (item.href && item.href.startsWith('#')) location.hash = item.href;
